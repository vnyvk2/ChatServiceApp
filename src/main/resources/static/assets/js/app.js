...
class ChatApp {
    ...
    setupEventListeners() {
        ...
        // Handle visibility change for status updates
    ...
    showChatSection() {
        ...
        document.getElementById('current-user').textContent = this.currentUser.displayName;
    ...
    connectWebSocket() {
        ...
        displayMyRooms(rooms) {
            ...
            rooms.forEach(membership => {
                ...
                roomElement.onclick = () => this.selectRoom(room.id, room.name, room.roomType);
